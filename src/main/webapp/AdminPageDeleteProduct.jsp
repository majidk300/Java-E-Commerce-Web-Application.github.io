        ...
        <div class="admin-panel">
            ...
            <div class="panel-right">
                ...
                <div class="form-right-part">
                    ...
                    <h3 style="color:#c1121f; border-bottom:2px solid red; max-width:180px; ">Delete Products</h3>
                        ...
                        <div class="featured">
                            ...
                            <div class="products">
                                ...
                                <div class="end-part">
                                    ...
                                    <div class="add-cart">
                                        <a href="deleteProductServlet?productId=<%=featureProducts.getId()%>" ><i class="fa fa-trash" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
